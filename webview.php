...
function garox($message) {
    ...
    $inputstyle = $ciyan . "[#] " . $grey . $message . ": " . $fgreen;
    echo $inputstyle;
}
...
-----------------------------------------";
echo $ciyan . "
  http://www.thecyberboytube.blogspot.com";
echo $ciyan . "
-----------------------------------------" . $grey . "
...
";
                        echo $ciyan . "--[#] " . $grey . "Enter '" . $ciyan . "R" . $grey . "' for restart
";
                        echo $ciyan . "--[#] " . $grey . "Enter '" . $merah . "X" . $grey . "' for keluar
